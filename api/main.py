...
from src.document_analyser.data_analysis import DataAnalysis
from src.document_compare.document_comparator import Documentcomparator
from src.document_chat.chat import ConversationalRAG
from utils.document_ops import FastAPIFileAdapter,read_pdf_via_handler
from logger.custom_logger import CustomLogger
log=CustomLogger().get_logger( name=__file__  )
...
async def compare_documents(reference: UploadFile = File(...), actual: UploadFile = File(...)) -> Any:
    try:
        ...
        dc = Documentcompare()
        ref_path, act_path = dc.save_documents(
